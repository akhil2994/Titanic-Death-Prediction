package test.java.de.daslaboratorium.machinelearning.classifier.bayes;
...
import main.java.de.daslaboratorium.machinelearning.classifier.Classification;
...
//		
//		.assertEquals(CATEGORY_NEGATIVE, list.get(0).getCategory());
